...
const dict = {
  fr: {
    ...
    // Signals
    'signals.nav':            'Signaux',
    'signals.live_badge':     'Temps réel',
    'signals.section_title':  'Live Signals',
    'signals.section_sub':    'Les derniers mouvements de probabilité et résolutions détectés par nos agents.',
    'signals.view_all':       'Voir tous les signaux →',
    'signals.view_question':  'Voir la question →',
    'signals.empty':          'Aucun signal disponible pour le moment.',
    'signals.page_title':     'Signaux en direct',
    'signals.page_sub':       'Flux complet des signaux de probabilité, résolutions et mouvements détectés.',
    'signals.filter_all':     'Tous les signaux',
    'signals.filter_shift':   'Glissements',
    'signals.filter_resolve': 'Résolutions',
    'signals.group_by':       'Grouper par',
    'signals.group_channel':  'Canal',
    'signals.group_date':     'Date',
    'signals.type_shift':     'Glissement',
    'signals.type_resolve':   'Résolu',
    'signals.type_signal':    'Signal',
    'signals.type_news':      'Actualité',
    'signals.severity_high':  'Haute',
    'signals.severity_med':   'Moyenne',
    'signals.severity_low':   'Basse',
    'signals.no_question':    'Sans question liée',
    'signals.sources_title':  'Sources de données',
    'signals.sources_sub':    'Nos agents s\'appuient sur un corpus de sources officielles classées par niveau de fiabilité.',
    'signals.tier1':          'Tier 1 — Sources primaires officielles',
    'signals.tier2':          'Tier 2 — Analyses internationales structurées',
    'signals.tier3':          'Tier 3 — Intelligence commerciale spécialisée',
  ...
  en: {
    ...
    // Signals
    'signals.nav':            'Signals',
    'signals.live_badge':     'Live',
    'signals.section_title':  'Live Signals',
    'signals.section_sub':    'Latest probability shifts and resolutions detected by our agents.',
    'signals.view_all':       'View all signals →',
    'signals.view_question':  'View question →',
    'signals.empty':          'No signals available yet.',
    'signals.page_title':     'Live Signals',
    'signals.page_sub':       'Full feed of probability signals, resolutions and detected market moves.',
    'signals.filter_all':     'All signals',
    'signals.filter_shift':   'Shifts',
    'signals.filter_resolve': 'Resolutions',
    'signals.group_by':       'Group by',
    'signals.group_channel':  'Channel',
    'signals.group_date':     'Date',
    'signals.type_shift':     'Shift',
    'signals.type_resolve':   'Resolved',
    'signals.type_signal':    'Signal',
    'signals.type_news':      'News',
    'signals.severity_high':  'High',
    'signals.severity_med':   'Medium',
    'signals.severity_low':   'Low',
    'signals.no_question':    'No linked question',
    'signals.sources_title':  'Data Sources',
    'signals.sources_sub':    'Our agents rely on a corpus of official sources ranked by trust tier.',
    'signals.tier1':          'Tier 1 — Primary official sources',
    'signals.tier2':          'Tier 2 — Structured international analysis',
    'signals.tier3':          'Tier 3 — Specialist commercial intelligence',
