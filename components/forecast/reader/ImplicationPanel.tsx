...
export function ImplicationPanel({ analysis: a, locale }: Props) {
  ...
  const jumpLinks = [
    { id: 'takeaway', label: t('Synthèse', 'Takeaway') },
    { id: 'why', label: t('Pourquoi', 'Why') },
    { id: 'immediate', label: t('Immédiat', 'Immediate') },
    { id: 'second-order', label: t('2nd ordre', '2nd order') },
    { id: 'regional', label: t('Régional', 'Regional') },
    { id: 'sectors', label: t('Secteurs', 'Sectors') },
    { id: 'watch', label: t('À suivre', 'Watch') },
    { id: 'forecasts', label: t('Prévisions', 'Forecasts') },
  ]
